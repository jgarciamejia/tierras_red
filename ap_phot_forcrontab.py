...
def main(raw_args=None):
	...
	#Select target and reference stars - JGM modification to ease use by crontab
	...
	targ_and_refs = reference_star_chooser(flattened_files, mode='automatic', nrefs=100, plot=True, nearness_limit=nearness_limit, edge_limit=edge_limit,dimness_limit=dimness_limit, targ_distance_limit=targ_distance_limit, overwrite=overwrite_refs,target_position=(target_position_x,target_position_y))
